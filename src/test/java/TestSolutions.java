...
class TestSolutions {
	...
	@Test
	void testProblem14() {
		assertEquals("837799", new Problem14().solve());
	}

	@Test
	void testProblem15() {
		assertEquals("137846528820", new Problem15().solve());
	}

	@Test
	void testProblem16() {
		assertEquals("1366", new Problem16().solve());
	}
	...
	@Test
	void testProblem19() {
		assertEquals("171", new Problem19().solve());
	}

	@Test
	void testProblem20() {
		assertEquals("648", new Problem20().solve());
	}

	@Test
	void testProblem21() {
		assertEquals("31626", new Problem21().solve());
	}

	@Test
	void testProblem22() {
		assertEquals("871198282", new Problem22().solve());
	}

	@Test
	void testProblem23() {
		assertEquals("4179871", new Problem23().solve());
	}
}
